...
>
	...
	>
		<div
			class="flex w-full text-left px-0.5 bg-transparent truncate text-gray-900 dark:text-gray-100 {triggerClassName} justify-between {($settings?.highContrastMode ??
			false)
